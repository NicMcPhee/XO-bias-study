...
For the sine regression problem, we limited our runs to bias-effective and non-bias-effective settings as described in Section~\ref{sec:Experiments}.
...
an excellent illustration of this can be seen in Figure 2 in~\cite{Boetticher:2006}. Another attempt to find a balance of diversity between parents is called sexual selection proposed by Goh et al.~\cite{gohsexualselection}. Their sexual selection
