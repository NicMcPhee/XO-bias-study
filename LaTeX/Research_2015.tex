...
where they refer to parent that contributes the root node as the \emph{root parent} and the other parent as
...
overall nodes, but also because for most function sets the root node (and the nodes near it) have an especially 
