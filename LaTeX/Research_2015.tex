...
The one problem not described elsewhere(\textbf{well? there is a paper that sort of describes it. search "us change problem" in gecco last year})  in the literature is the U.S. Change problem, a program 
