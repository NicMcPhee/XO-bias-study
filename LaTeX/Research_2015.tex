...
Additionally, various combinations of the following parameters were used across all tested problems:
...
Any additions or alterations to this list made for specific problems are discussed within their respective sections.
...
For the Pagie-1 problem we did runs across the parameters outlined in Section~\ref{sec:Results}, with the following
