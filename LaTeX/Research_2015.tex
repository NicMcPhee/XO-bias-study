...
Nicholas Freitag McPhee\\
	...
	\affaddr{mcphee@morris.umn.edu}
\alignauthor
M. Kirbie Dramdahl\\
	\affaddr{Div. of Science and Math}\\
	\affaddr{U of Minnesota, Morris}\\
	\affaddr{Morris, MN USA-56267}\\
	\affaddr{dramd002@morris.umn.edu}
\alignauthor
David Donatucci\\
	\affaddr{Div. of Science and Math}\\
	\affaddr{U of Minnesota, Morris}\\
	\affaddr{Morris, MN USA-56267}\\
	\affaddr{donat056@morris.umn.edu}
}
...
\begin{thebibliography}{10}
	...
	\bibitem{beadle2008semantically}
	L.~Beadle and C.~G. Johnson.
	\newblock Semantically driven crossover in genetic programming.
	\newblock In {\em IEEE World Congress on Computational Intelligence}, pages
	111--116, 2008.
	
	\bibitem{Boetticher:2006}
	G.~D. Boetticher and K.~Kaminsky.
	\newblock The assessment and application of lineage information in genetic
	programs for producing better models.
	\newblock In {\em Information Reuse and Integration, 2006 IEEE International
		Conference on}, pages 141--146, Sept 2006.
	
	\bibitem{brameier2007linear}
	M.~F. Brameier and W.~Banzhaf.
	\newblock {\em Linear genetic programming}.
	\newblock Springer Science \& Business Media, 2007.
	
	\bibitem{burlacu2013visualization}
	B.~Burlacu, M.~Affenzeller, M.~Kommenda, S.~Winkler, and G.~Kronberger.
	\newblock Visualization of genetic lineages and inheritance information in
	genetic programming.
	\newblock In {\em Proceedings of the 15th annual conference companion on
		Genetic and evolutionary computation}, pages 1351--1358. ACM, 2013.
	
	\bibitem{gohsexualselection}
	K.~Goh, A.~Lim, and B.~Rodrigues.
	\newblock Sexual selection for genetic algorithms.
	\newblock {\em Artificial Intelligence Review}, 19(2):123--152, 2003.
	
	\bibitem{Gustafson:2005}
	S.~Gustafson, E.~Burke, and N.~Krasnogor.
	\newblock On improving genetic programming for symbolic regression.
	\newblock In {\em Evolutionary Computation, 2005. The 2005 IEEE Congress on},
	volume~1, pages 912--919 Vol.1, Sept 2005.
	
	\bibitem{Helmuth:GECCO15}
	T.~Helmuth and L.~Spector.
	\newblock General program synthesis benchmark suite.
	\newblock In {\em Proceedings of the 17th Annual Conference on Genetic and
		Evolutionary Computation}, GECCO '15, New York, NY, USA, 2015. ACM.
	
	\bibitem{hoang2006ordertree}
	T.-H. Hoang, N.~X. Hoai, N.~T. Hien, R.~I. McKay, and D.~Essam.
	\newblock {ORDERTREE}: a new test problem for genetic programming.
	\newblock In {\em Proceedings of the 8th annual conference on Genetic and
		evolutionary computation}, pages 807--814. ACM, 2006.
	
	\bibitem{mcdermott2012genetic}
	J.~McDermott, D.~R. White, S.~Luke, L.~Manzoni, M.~Castelli, L.~Vanneschi,
	W.~Jaskowski, K.~Krawiec, R.~Harper, K.~De~Jong, et~al.
	...
	\newblock In {\em Proceedings of the 14th annual conference on Genetic and
		evolutionary computation}, pages 791--798. ACM, 2012.
	
	\bibitem{McPheeDonatucciDramdahl:2014}
	N.~F. McPhee, D.~Donatucci, and M.~K. Dramdahl.
	\newblock Analysis of genetic programming ancestry using a graph database.
	\newblock In {\em Proceedings of Midwest Instruction and Computing Symposium}.
	MICS, 2014.
	
	\bibitem{mcphee1999analysis}
	N.~F. McPhee and N.~J. Hopper.
	\newblock Analysis of genetic diversity through population history.
	\newblock In {\em Proceedings of the Genetic and Evolutionary Computation
		Conference}, volume~2, pages 1112--1120. GECCO, 1999.
	
	\bibitem{McPhee:2008:SBB:1792694.1792707}
	N.~F. McPhee, B.~Ohs, and T.~Hutchison.
	\newblock Semantic building blocks in genetic programming.
	\newblock In {\em Proceedings of the 11th European Conference on Genetic
		Programming}, EuroGP'08, pages 134--145, Berlin, Heidelberg, 2008.
	Springer-Verlag.
	
	\vfill\eject
	
	\bibitem{moraglio2012geometric}
	A.~Moraglio, K.~Krawiec, and C.~G. Johnson.
	\newblock Geometric semantic genetic programming.
	\newblock In {\em Parallel Problem Solving from Nature-PPSN XII}, pages 21--31.
	Springer, 2012.
	
	\bibitem{o2003grammatical}
	M.~O'Neill and C.~Ryan.
	\newblock {\em Grammatical evolution: evolutionary automatic programming in an
		arbitrary language}, volume~4.
	\newblock Springer Science \& Business Media, 2003.
	
	\bibitem{pagie1997evolutionary}
	L.~Pagie and P.~Hogeweg.
	\newblock Evolutionary consequences of coevolving targets.
	\newblock {\em Evolutionary computation}, 5(4):401--418, 1997.
	
	\bibitem{poli08:fieldguide}
	R.~Poli, W.~B. Langdon, and N.~F. McPhee.
	\newblock {\em A Field Guide to Genetic Programming}.
	\newblock Published via \texttt{http://lulu.com} and freely available at
	\texttt{http://www.gp-field-guide.org.uk}, 2008.
	\newblock (With contributions by J. R. Koza).
	
	\bibitem{qvarnstrom2009speciation}
	A.~Qvarnstr{\"o}m and R.~I. Bailey.
	\newblock Speciation through evolution of sex-linked genes.
	\newblock {\em Heredity}, 102(1):4--15, 2009.
	...
	\bibitem{ryan1994pygmies}
	C.~Ryan.
	\newblock Pygmies and civil servants.
	\newblock In {\em Advances in Genetic Programming}, pages 243--263. MIT Press,
	1994.
	
	\bibitem{spector:2002:GPEM}
	L.~Spector and A.~Robinson.
	\newblock Genetic programming and autoconstructive evolution with the push
	programming language.
	\newblock {\em Genetic Programming and Evolvable Machines}, 3(1):7--40, Mar.
	2002.
	
	\bibitem{uy2011semantically}
	N.~Q. Uy, N.~X. Hoai, M.~O'Neill, R.~I. McKay, and E.~Galv{\'a}n-L{\'o}pez.
	\newblock Semantically-based crossover in genetic programming: application to
	real-valued symbolic regression.
	\newblock {\em Genetic Programming and Evolvable Machines}, 12(2):91--119,
	2011.
	
	\bibitem{uy2013roles}
	N.~Q. Uy, N.~X. Hoai, M.~O'Neill, R.~I. McKay, and D.~N. Phong.
	\newblock On the roles of semantic locality of crossover in genetic
	programming.
	\newblock {\em Information Sciences}, 235:195--213, 2013.
	
	\bibitem{vanneschi2011k}
	L.~Vanneschi, M.~Castelli, and L.~Manzoni.
	\newblock The {K} landscapes: a tunably difficult benchmark for genetic
	programming.
	\newblock In {\em Proceedings of the 13th annual conference on Genetic and
		evolutionary computation}, pages 1467--1474. ACM, 2011.
	
	\bibitem{gp-benchmarks-2013}
	D.~R. White, J.~McDermott, M.~Castelli, L.~Manzoni, B.~W. Goldman,
	G.~Kronberger, W.~Ja{\'s}kowski, U.-M. O'Reilly, and S.~Luke.
	\newblock Better {GP} benchmarks: Community survey results and proposals.
	\newblock {\em Genetic Programming and Evolvable Machines}, 14:3--29, 2013.
	...
	\bibitem{zhan2014quantitative}
	H.~Zhan.
	\newblock A quantitative analysis of the simplification genetic operator.
	\newblock In {\em Proceedings of the 2014 conference companion on Genetic and
		evolutionary computation companion}, pages 1077--1080. ACM, 2014.
