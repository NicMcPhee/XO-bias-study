...
\begin{figure}
\centering
\includegraphics[width=0.45 \textwidth]{Plots/Parent_error_diffs_sine.pdf}
\caption{Plot of the differences in parent errors from some sine runs. \textbf{Explain this}.}
