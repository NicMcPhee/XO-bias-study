...
\caption{Impact of crossover bias on fitness for K-Landscapes problem, $K=6$. \textbf{Redraw this figure with a squaring y-axis and transparency on the boxes so we can see the points. Also do non-transparent so we can choose.}}
...
selection, no elitism, and population size 10,240. \textbf{Redraw this with transparent boxes so we can see the points.}}
...
\caption{Impact of crossover bias on fitness for K-Landscapes problem, $K=6$. \textbf{Drop this.}}
...
\caption{Impact of crossover bias on fitness for K-Landscapes problem, $K=6$, restricted to binary tournament 
selection, no elitism, and population size 10,240. \textbf{Drop this.}}
